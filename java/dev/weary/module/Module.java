...
import dev.weary.helpcommand.HelpModule;
import dev.weary.limitedcommands.LimitedCommandsModule;
import dev.weary.mineman.MinemanModule;
...
public abstract class Module {
    ...
    private static final String CONFIG_MODULE_DESCRIPTION = "description";
    ...
    private static void initializeAllModules() {
        initializeModule(new MinemanModule());
        initializeModule(new LimitedCommandsModule());
        initializeModule(new HelpModule());
    }
}
